...
void codeGenExpression(FILE *fp, tNode *head)
{
    ...
    else
    {
        ...
        if (head->node.n->is_operator)
        {
            ...
            {
                if(head->parent->leafTag && head->parent->node.n->is_operator && head->parent->node.n->s.T == MINUS && head->parent->node.n->child != head)
                {
                    //printf("Yes\n");
                    fprintf(fp, "POP ECX\n");
                    fprintf(fp, "ADD ECX, EBX\n");
                    fprintf(fp, "PUSH ECX\n");
                    fprintf(fp, "PUSH EAX\n");
                }
                else{
            ...
            {
                if(head->parent->leafTag && head->parent->node.n->is_operator && head->parent->node.n->s.T == DIV && head->parent->node.n->child != head)
                {
                    //printf("Yes\n");
                    fprintf(fp, "POP ECX\n");
                   ...
                   // printf("%s\n", terminalDict[head->parent->node.n->s.T]);
                fprintf(fp, "MUL EBX\n");
                fprintf(fp, "PUSH EAX\n");}
            }
